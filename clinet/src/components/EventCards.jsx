...
function EventCards(props) {
  return (
    <div className="cards">
      <div onClick={() => window.location=`/Event/${props.placeName}`}>
      ...
      <div className="flexCal">
        <div className="flexRow">
          ...
          <div className="flexfav">
            <h3 className="status" style={{color: props.status == "Live" ? "green" : "red"}} >{props.status}</h3>
            <Favorite placeId={props.theCardId} placeName={props.placeName} className="favorite"></Favorite>
          </div>
        </div>
        <div className="flexTypes">
          <h4 className="Type3"><span>{props.wifi}</span></h4>
